...
(function(window) {
    ...
    Code.PhotoSwipe.Util = {
        ...
        browser: {
            ...
            msie: /msie/i.test(navigator.userAgent) && !/opera/.test(
                navigator.userAgent),
            ...
            isEventSupported: function(eventName) {
                var el = document.createElement(this._eventTagNames[
                    eventName] || 'div');
    ...
    if (Code.PhotoSwipe.Util.browser.webkit) {
        ...
        Code.PhotoSwipe.Util.browser.is3dSupported = !Code.PhotoSwipe.Util.isNothing(
            test3DEl.style.WebkitPerspective);
    }

    Code.PhotoSwipe.Util.browser.touchSupported = Code.PhotoSwipe.Util.browser
        .isEventSupported('touchstart');
    Code.PhotoSwipe.Util.browser.gestureSupported = Code.PhotoSwipe.Util.browser
        .isEventSupported('gesturestart');
    ...
    Util.extend(Util, {
        ...
        DOM: {
            ...
            createElement: function(type, attributes, content) {
                ...
                for (var attribute in attributes) {
                    if (attributes.hasOwnProperty(attribute)) {
                        retval.setAttribute(attribute, attributes[
                            attribute]);
                    }
                }
            ...
            removeChildren: function(parentEl) {
                ...
                if (parentEl.hasChildNodes()) {
                    ...
                    while (parentEl.childNodes.length >= 1) {
                        parentEl.removeChild(parentEl.childNodes[
            ...
            addClass: function(el, className) {
                ...
                var currentClassValue = Util.DOM.getAttribute(el,
                    'class');
                ...
                if (!re.test(currentClassValue)) {
                    ...
                    Util.DOM.setAttribute(el, 'class',
                        currentClassValue);
                }
            ...
            hide: function(el) {
                ...
                Util.setElementData(el, 'oldDisplayValue', Util.DOM.getStyle(
                    el, 'display'));
            ...
            show: function(el) {
                ...
                if (Util.DOM.getStyle(el, 'display') == 'none') {
                    var oldDisplayValue = Util.getElementData(el,
            ...
            outerWidth: function(el) {
                ...
                retval += parseInt(Util.DOM.getStyle(el, 'padding-left'),
                    10) + parseInt(Util.DOM.getStyle(el,
                    'padding-right'), 10);
                retval += parseInt(Util.DOM.getStyle(el, 'margin-left'),
                    10) + parseInt(Util.DOM.getStyle(el, 'margin-right'),
                    10);
                retval += parseInt(Util.DOM.getStyle(el,
                    'border-left-width'), 10) + parseInt(Util.DOM.getStyle(
                    el, 'border-right-width'), 10);
                return retval;
            ...
            _getDimension: function(el, dimension) {
                ...
                var retval = window.parseInt(window.getComputedStyle(el,
                        '')
                ...
                if (isNaN(retval)) {
                    ...
                    retval = window.parseInt(window.getComputedStyle(el,
                            '')
                        .getPropertyValue(dimension));
            ...
            outerHeight: function(el) {
                ...
                retval += parseInt(Util.DOM.getStyle(el, 'padding-top'),
                    10) + parseInt(Util.DOM.getStyle(el,
                    'padding-bottom'), 10);
                retval += parseInt(Util.DOM.getStyle(el, 'margin-top'),
                    10) + parseInt(Util.DOM.getStyle(el,
                    'margin-bottom'), 10);
                retval += parseInt(Util.DOM.getStyle(el,
                    'border-top-width'), 10) + parseInt(Util.DOM.getStyle(
                    el, 'border-bottom-width'), 10);
            ...
            getMousePosition: function(event) {
                ...
                if (event.pageX) {
                    ...
                    retval.x = event.clientX + (document.documentElement
                ...
                if (event.pageY) {
                    ...
                    retval.y = event.clientY + (document.documentElement
...
(function(window, Util) {
    ...
    Util.extend(Util, {
        ...
        Animation: {
             ...
             */
            _setTransition: function(el, property, duration,
                timingFunction, delay, callback) {
            ...
            _setTransitionEndEventListener: function(el) {
                ...
                Util.setElementData(el, 'transitionEndEvent', function(
                    e) {

                    var el = e.target;

                    Util.DOM.removeEventListener(el, Util.Animation
                        ._getTransitionEndEventLabel(), Util.getElementData(
                            el, 'transitionEndEvent'));
                    Util.removeElementData(el, 'transitionEndEvent');

                    var callback = Util.getElementData(el,
                        'transitionEndCallback');
                    Util.removeElementData(el,
                        'transitionEndCallback');
                ...
                Util.DOM.addEventListener(el, Util.Animation._getTransitionEndEventLabel(),
            ...
            _getTransitionEndEventLabel: function() {
                ...
                return (document.documentElement.style.WebkitTransition !==
                    undefined) ? "webkitTransitionEnd" :
                    "transitionend";
            ...
            _getTransitionPrefix: function() {
                ...
                return (document.documentElement.style.WebkitTransition !==
                    undefined) ? "webkitTransition" : (document.documentElement
            ...
            stopFade: function(el) {
                ...
                var fadeCallback = Util.getElementData(el,
                    'transitionEndEvent');
                ...
                var currentOpacity = window.getComputedStyle(el, '')
            ...
            fadeIn: function(el, opacity, duration, callback) {
                ...
                Util.setElementData(el, 'transitionEndCallback',
                    callback);

                Util.Animation._setTransition(el, 'opacity', duration +
                    'ms', function(el) {

                        Util.Animation._setTransitionEndEventListener(
                            el);
            ...
            slideBy: function(el, xPos, yPos, duration, callback) {
                ...
                Util.setElementData(el, 'transitionEndCallback', Util.Animation
                    ._onSlideByEnd);
                ...
                //ease-in-out
                Util.Animation._setTransition(el, 'all', duration +
                    'ms', 'ease-in', 0, function(el) {
            ...
            _onSlideByEnd: function(e) {
                ...
                el = e.target,
                    ...
                    callback = Util.getElementData(el,
                        'slideByCallback'),

                    transform = Util.coalesce(el.style.webkitTransform,
                        el.style.MozTransform, el.style.transform),

                    transformExploded = transform.match(/\((.*?)\)/)[1]
                        .split(', '),
...
(function(window, Util) {
    ...
    Code.PhotoSwipe.FullSizeImageClass = Code.PhotoSwipe.EventClass.extend({
        ...
        onLoad: function() {
            ...
            this.dispatchEvent(Code.PhotoSwipe.FullSizeImageClass.EventTypes
                .onLoad);
    ...
    Code.PhotoSwipe.DocumentOverlayClass = Code.PhotoSwipe.ElementClass.extend({
        ...
        init: function(options) {
            ...
            this.el = Util.DOM.createElement('div', {
                'class': Code.PhotoSwipe.DocumentOverlayClass.CssClasses
                    .documentOverlay
            }, '');
    ...
    Code.PhotoSwipe.ViewportClass = Code.PhotoSwipe.ElementClass.extend({
        ...
        init: function(options) {
            ...
            if (Util.browser.gestureSupported) {
                this.gestureStartHandler = this.onGestureStart.bind(
                    this);
                this.gestureChangeHandler = this.onGestureChange.bind(
                    this);
        ...
        addEventListeners: function() {
            ...
            if (Util.browser.gestureSupported) {
                Util.DOM.addEventListener(this.el, 'gesturestart', this
                    .gestureStartHandler);
                Util.DOM.addEventListener(this.el, 'gesturechange',
        ...
        removeEventListeners: function() {
            ...
            if (Util.browser.touchSupported) {
                Util.DOM.removeEventListener(this.el, 'touchstart',
                    this.touchStartHandler);
                Util.DOM.removeEventListener(this.el, 'touchmove', this
                    .touchMoveHandler);
                Util.DOM.removeEventListener(this.el, 'touchend', this.touchEndHandler);
            }

            if (Util.browser.gestureSupported) {
                Util.DOM.removeEventListener(this.el, 'gesturestart',
                    this.gestureStartHandler);
                Util.DOM.removeEventListener(this.el, 'gesturechange',
                    this.gestureChangeHandler);
                Util.DOM.removeEventListener(this.el, 'gestureend',
        ...
        onTouchEnd: function(e) {
            ...
            var
            touchEvent = Util.DOM.getTouchEvent(e),
                touches = (!Util.isNothing(touchEvent.changedTouches)) ?
        ...
        onMouseUp: function(e) {
            ...
            e.preventDefault();
            this.fireTouchEvent(this.touchStartPoint, Util.DOM.getMousePosition(
                e));
...
(function(window, Util, FullSizeImageClass) {
    ...
    Code.PhotoSwipe.SliderItemClass = Code.PhotoSwipe.EventClass.extend({
        ...
        init: function(parentEl) {
            ...
            this.el = Util.DOM.createElement('div', {
                'class': Code.PhotoSwipe.SliderItemClass.CssClasses
                    .item + ' ' + Code.PhotoSwipe.SliderItemClass.CssClasses
                    .loading
            }, '');
            Util.DOM.setStyle(this.el, {
                position: 'absolute',
        ...
        resetImagePosition: function() {
            ...
            newWidth = Math.round(this.fullSizeImage.naturalWidth *
                scale);
            newHeight = Math.round(this.fullSizeImage.naturalHeight *
                scale);
        ...
        setFullSizeImage: function(fullSizeImage) {
            ...
            Util.DOM.removeClass(this.el, Code.PhotoSwipe.SliderItemClass
                .CssClasses.loading);
            Util.DOM.removeClass(this.el, Code.PhotoSwipe.SliderItemClass
                .CssClasses.imageError);

            // Something is wrong!
            if (Util.isNothing(this.fullSizeImage)) {
                this.fullSizeImage = null;
                Util.DOM.addClass(this.el, Code.PhotoSwipe.SliderItemClass
                    .CssClasses.imageError);
                this.hideImage();
                return;
            }
            ...
            Util.DOM.setAttribute(this.imageEl, 'src', this.fullSizeImage
                .src);

            this.resetImagePosition();

            this.dispatchEvent(Code.PhotoSwipe.SliderItemClass.EventTypes
                .onFullSizeImageDisplay);
        ...
        onFullSizeImageLoad: function(e) {
            ...
            e.target.removeEventListener(FullSizeImageClass.EventTypes.onLoad,
                this.fullSizeImageLoadEventHandler);

            if (Util.isNothing(this.fullSizeImage) || e.target.index !==
                this.fullSizeImage.index) {
                ...
                this.dispatchEvent({
                    type: Code.PhotoSwipe.SliderItemClass.EventTypes
                        .onFullSizeImageLoadAnomaly,
                    target: this,
...
(function(window, Util, SliderItemClass) {
    ...
    Code.PhotoSwipe.SliderClass = Code.PhotoSwipe.ElementClass.extend({
        ...
        init: function(options, parentEl) {
            ...
            this.showPreviousEndEventHandler = this.onShowPreviousEnd.bind(
                this);
            this.bounceStepOneEventHandler = this.onBounceStepOne.bind(
                this);
            this.bounceStepTwoEventHandler = this.onBounceStepTwo.bind(
                this);

            this.sliderFullSizeImageLoadAnomalyEventHandler = this.onSliderFullSizeImageLoadAnomaly
                .bind(this);
        ...
        resetPosition: function() {
            ...
            // Re-position items
            this.previousItem.resetPosition(this.parentElWidth, this.parentElHeight,
                0);
            this.currentItem.resetPosition(this.parentElWidth, this.parentElHeight,
                this.parentElWidth);
            this.nextItem.resetPosition(this.parentElWidth, this.parentElHeight,
                this.parentElWidth * 2);
         ...
         */
        setPreviousAndNextFullSizeImages: function(
            previousFullSizeImage, nextFullSizeImage) {
        ...
        showNext: function() {
            ...
            this.lastShowAction = Code.PhotoSwipe.SliderClass.ShowActionTypes
                .next;
            this.hasBounced = false;
            ...
            Util.Animation.slideBy(this.el, slideBy, 0, this.settings.slideSpeed,
                this.showNextEndEventHandler);
        ...
        showPrevious: function() {
            ...
            Util.Animation.slideBy(this.el, slideBy, 0, this.settings.slideSpeed,
                this.showPreviousEndEventHandler);
        ...
        bounce: function() {
            ...
            Util.Animation.slideBy(
                this.el, (this.lastShowAction === Code.PhotoSwipe.SliderClass
                    .ShowActionTypes.previous) ? this.bounceSlideBy :
        ...
        onShowNextEnd: function() {
            ...
            Util.DOM.setStyle(this.currentItem.el, 'left',
                parentElWidth + 'px');
            Util.DOM.setStyle(this.nextItem.el, 'left', (parentElWidth *
                2) + 'px');
        ...
        onSliderFullSizeImageLoadAnomaly: function(e) {
            ...
            if (!Util.isNothing(this.currentItem.fullSizeImage)) {
                if (this.currentItem.fullSizeImage.index ===
                    fullSizeImage.index) {
            ...
            if (!Util.isNothing(this.nextItem.fullSizeImage)) {
                if (this.nextItem.fullSizeImage.index === fullSizeImage
                    .index) {
            ...
            if (!Util.isNothing(this.previousItem.fullSizeImage)) {
                if (this.previousItem.fullSizeImage.index ===
                    fullSizeImage.index) {
    ...
    Code.PhotoSwipe.CaptionClass = Code.PhotoSwipe.ElementClass.extend({
        ...
        init: function(options) {
            ...
            if (this.settings.position === 'bottom') {
                cssClass = cssClass + ' ' + Code.PhotoSwipe.CaptionClass
                    .CssClasses.bottom;
            }
        ...
        resetPosition: function() {
            ...
            if (this.settings.position === 'bottom') {
                top = Util.DOM.windowHeight() - Util.DOM.outerHeight(
                    this.el) + Util.DOM.windowScrollTop();
            }
            else {
    ...
    Code.PhotoSwipe.ToolbarClass = Code.PhotoSwipe.ElementClass.extend({
        ...
        init: function(options) {
            ...
            if (this.settings.position === 'top') {
                cssClass = cssClass + ' ' + Code.PhotoSwipe.ToolbarClass
                    .CssClasses.top;
            }
            ...
            this.closeEl = Util.DOM.createElement('div', {
                ...
                }, '<div class="' + Code.PhotoSwipe.ToolbarClass.CssClasses
                .content + '"></div>');
            ...
            // Previous
            this.previousEl = Util.DOM.createElement('div', {
            ...
            // Next
            this.nextEl = Util.DOM.createElement('div', {
        ...
        addEventListeners: function() {
            ...
            if (Util.browser.touchSupported) {
                ...
                if (!Util.browser.isBlackberry) {
                    Util.DOM.addEventListener(this.el, 'touchstart',
                        this.touchStartHandler);
                }
                Util.DOM.addEventListener(this.el, 'touchmove', this.touchMoveHandler);
            }
        ...
        setNextState: function(disable) {
            ...
            if (disable) {
                Util.DOM.addClass(this.nextEl, Code.PhotoSwipe.ToolbarClass
                    .CssClasses.nextDisabled);
                this.isNextActive = false;
            }
            else {
                Util.DOM.removeClass(this.nextEl, Code.PhotoSwipe.ToolbarClass
                    .CssClasses.nextDisabled);
                this.isNextActive = true;
            }
        ...
        setPreviousState: function(disable) {
            ...
            if (disable) {
                Util.DOM.addClass(this.previousEl, Code.PhotoSwipe.ToolbarClass
                    .CssClasses.previousDisabled);
                this.isPreviousActive = false;
            }
            else {
                Util.DOM.removeClass(this.previousEl, Code.PhotoSwipe.ToolbarClass
                    .CssClasses.previousDisabled);
                this.isPreviousActive = true;
            }
...
(function(window, Util, CaptionClass, ToolbarClass) {
    ...
    Code.PhotoSwipe.CaptionToolbarClass = Code.PhotoSwipe.EventClass.extend({
        ...
        init: function(options) {
            ...
            this.toolbarClickEventHandler = this.onToolbarClick.bind(
                this);
        ...
        addEventListeners: function() {
            ...
            this.toolbar.addEventListener(ToolbarClass.EventTypes.onClick,
        ...
        removeEventListeners: function() {
            ...
            this.toolbar.removeEventListener(ToolbarClass.EventTypes.onClick,
                this.toolbarClickEventHandler);
            this.hasAddedEventListeners = false;
...
(function(window, Util) {
    ...
    Code.PhotoSwipe.ZoomPanRotateClass = Code.PhotoSwipe.ElementClass.extend({
        ...
        init: function(options, parentEl, imageEl) {
            ...
            // Create element and append to body
            this.el = Util.DOM.createElement('div', {
                'class': Code.PhotoSwipe.ZoomPanRotateClass.CssClasses
                    .documentOverlay
            }, '');
            Util.DOM.setStyle(this.el, {
                left: 0,
        ...
        setStartingTranslateFromCurrentTranform: function() {
            ...
            var transformExploded = this.containerEl.style.webkitTransform
                .match(/translate\((.*?)\)/);

            if (!Util.isNothing(transformExploded)) {

                transformExploded = transformExploded[1].split(', ');
                this.transformSettings.startingTranslateX = window.parseInt(
                    transformExploded[0]);
                this.transformSettings.startingTranslateY = window.parseInt(
                    transformExploded[1]);
        ...
        setStartingScaleAndRotation: function(scaleValue, rotationValue) {
            ...
            var scale = this.transformSettings.startingScale *
                scaleValue;

            if (this.settings.minZoom !== 0 && scale < this.settings.minZoom) {
                scale = this.settings.minZoom;
            }
            else if (this.settings.maxZoom !== 0 && scale > this.settings
                .maxZoom) {
        ...
        pan: function(point) {
            ...
            dx = point.x - this.panStartingPoint.x,
                ...
                dxScaleAdjust = (this.settings.adjustPanToZoom) ? dx /
                    this.transformSettings.scale : dx,
                dyScaleAdjust = dy / this.transformSettings.scale ? dy /
                    this.transformSettings.scale : dy;
        ...
        applyTransform: function() {
            ...
            this.containerEl.style.webkitTransform = 'scale(' + this.transformSettings
                .scale + ') rotate(' + (this.transformSettings.rotation %
                    360) + 'deg) translate(' + this.transformSettings.translateX +
                'px, ' + this.transformSettings.translateY + 'px)';
...
(function(window, Util, ElementClass, DocumentOverlayClass, FullSizeImageClass,
    ...
    CaptionToolbarClass, ZoomPanRotateClass) {
    ...
    var photoSwipe = Code.PhotoSwipe.EventClass.extend({
        ...
        init: function() {
            ...
            this.settings = {
                ...
                jQueryMobile: (!Util.isNothing(window.jQuery) && !Util.isNothing(
            ...
            this.viewportFadeInEventHandler = this.onViewportFadeIn.bind(
                this);
            this.windowOrientationChangeEventHandler = this.onWindowOrientationChange
                .bind(this);
            this.windowScrollEventHandler = this.onWindowScroll.bind(
                this);
            this.windowHashChangeHandler = this.onWindowHashChange.bind(
                this);
            this.keyDownEventHandler = this.onKeyDown.bind(this);
            this.viewportTouchEventHandler = this.onViewportTouch.bind(
                this);
            this.viewportFadeOutEventHandler = this.onViewportFadeOut.bind(
                this);
            this.sliderDisplayCurrentFullSizeImageEventHandler = this.onSliderDisplayCurrentFullSizeImage
                .bind(this);
            this.toolbarClickEventHandler = this.onToolbarClick.bind(
                this);
        ...
        show: function(startingIndex) {
            ...
            Util.DOM.addClass(document.body, Code.PhotoSwipe.CssClasses
                .activeBody);
            ...
            if (startingIndex < 0 || startingIndex >= this.fullSizeImages
                .length) {
                startingIndex = 0;
            }
        ...
        addEventListeners: function() {
            ...
            if (Util.browser.isAndroid) {
                ...
                var supportsOrientationChange = 'onorientationchange' in
                    window;
                this.orientationEventName = supportsOrientationChange ?
                    'orientationchange' : 'resize';
            }

            Util.DOM.addEventListener(window, this.orientationEventName,
            ...
            if (this.isBackEventSupported && this.settings.backButtonHideEnabled) {
                ...
                if (this.settings.jQueryMobile) {
                    ...
                    this.currentHistoryHashValue = 'PhotoSwipe' + new Date()
                        .getTime()
                        .toString();
            ...
            this.viewport.addEventListener(ViewportClass.EventTypes.onTouch,
                this.viewportTouchEventHandler);

            // Set slider handlers
            this.slider.addEventListener(SliderClass.EventTypes.onDisplayCurrentFullSizeImage,
                this.sliderDisplayCurrentFullSizeImageEventHandler);

            // Set captionAndToolbar handlers
            this.captionAndToolbar.addEventListener(ToolbarClass.EventTypes
                .onClick, this.toolbarClickEventHandler);
        ...
        removeEventListeners: function() {
            ...
            Util.DOM.removeEventListener(window, this.orientationEventName,
                this.windowOrientationChangeEventHandler);

            Util.DOM.removeEventListener(window, 'scroll', this.windowScrollEventHandler);

            if (this.isBackEventSupported && this.settings.backButtonHideEnabled) {
                Util.DOM.removeEventListener(window, 'hashchange', this
                    .windowHashChangeHandler);
            }
            ...
            this.viewport.removeEventListener(ViewportClass.EventTypes.onTouch,
                this.viewportTouchEventHandler);

            // Remove slider handlers
            this.slider.removeEventListener(SliderClass.EventTypes.onDisplayCurrentFullSizeImage,
                this.sliderDisplayCurrentFullSizeImageEventHandler);
        ...
        onViewportFadeIn: function(e) {
            ...
            this.slider.setCurrentFullSizeImage(this.fullSizeImages[
                this.currentIndex]);
        ...
        setSliderPreviousAndNextFullSizeImages: function() {
            ...
            if (this.fullSizeImages.length > 1) {
                ...
                // Current image is the first
                    ...
                    nextFullSizeImage = this.fullSizeImages[this.currentIndex +
                        1];
                    if (this.settings.loop) {
                        previousFullSizeImage = this.fullSizeImages[
                            lastIndex];
                    }
            ...
            this.slider.setPreviousAndNextFullSizeImages(
                previousFullSizeImage, nextFullSizeImage);
        ...
        onViewportTouch: function(e) {
            ...
            switch (e.action) {
                ...
                case ViewportClass.Actions.gestureChange:
                    ...
                    if (this.isZoomActive()) {
                        this.zoomPanRotate.zoomRotate(e.scale, (this.settings
                                .allowRotationOnUserZoom) ? e.rotation :
                            0);
                    }
                    break;
                ...
                case ViewportClass.Actions.gestureEnd:
                    ...
                    if (this.isZoomActive()) {
                        this.zoomPanRotate.setStartingScaleAndRotation(
                            e.scale, (this.settings.allowRotationOnUserZoom) ?
                            e.rotation : 0);
                    }
                    break;
        ...
        onViewportFadeOut: function(e) {
            ...
            this.viewport.removeEventListener(ElementClass.EventTypes.onFadeOut,
        ...
        hide: function() {
            ...
            Util.DOM.removeClass(document.body, Code.PhotoSwipe.CssClasses
                .activeBody);

            this.viewport.addEventListener(ElementClass.EventTypes.onFadeOut,
                this.viewportFadeOutEventHandler);
        ...
        onSliderDisplayCurrentFullSizeImage: function(e) {
            ...
            if (!this.settings.captionAndToolbarHide) {
                ...
                this.captionAndToolbar.setCaptionValue(this.fullSizeImages[
        ...
        fadeOutCaptionAndToolbar: function() {
            ...
            if (!this.settings.captionAndToolbarHide && !this.captionAndToolbar
                .isHidden) {
                this.dispatchEvent(Code.PhotoSwipe.EventTypes.onBeforeCaptionAndToolbarHide);
                this.captionAndToolbar.fadeOut();
            }
    ...
    Code.photoSwipe = function(thumbEls, containerEl, opts) {
        ...
        if (Util.isString(containerEl)) {
            containerEl = document.documentElement.querySelector(
                containerEl);
        }
        ...
        if (useEventDelegation) {
            ...
            containerEl.addEventListener('click', function(e) {
                ...
                var findNode = function(clickedEl, targetNodeName,
                    ...
                    if (Util.isNothing(clickedEl) || Util.isNothing(
                        targetNodeName) || Util.isNothing(stopAtEl)) {
                        return null;
                    }
                ...
                var clickedEl = findNode(e.target, thumbEls[0].nodeName,
                    e.currentTarget);
    ...
    if (!Util.isNothing(window.jQuery)) {
        ...
        window.jQuery.fn.photoSwipe = function(opts) {
            ...
            jQuery(thumbEls)
                .on('click', thumbEls, function(e) {

                    e.preventDefault();

                    var startingIndex = jQuery(thumbEls)
                        .index(jQuery(e.currentTarget));
                    Code.PhotoSwipe.Current.show(startingIndex);
